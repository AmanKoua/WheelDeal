...
public class JWTService {
    ...
    private static final String SECRET_KEY = "ThisIsATemporaryKeyForTestingAndCanBeReplacedAtAnyTime";
    ...
    public String extractUsername(String jwt) {return extractClaims(jwt, Claims::getSubject);}
